...
-- Migration 00014: Fix Diagnostic Report SHA-256 Digest Schema Qualification
-- Forward-only, idempotent, security definer search_path protected
-- Schema-qualifies pgcrypto digest call: encode(extensions.digest(convert_to(..., 'UTF8'), 'sha256'), 'hex')
-- ============================================================================
