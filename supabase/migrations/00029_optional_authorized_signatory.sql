...
-- Migration 00029: Optional Authorized Signatory for Final Reports
...
BEGIN
    ...
    v_snapshot := jsonb_build_object(
        ...
        'signatories', jsonb_build_object(
            ...
            'authorized_by', CASE WHEN p_signed_by_id IS NULL THEN NULL::JSONB ELSE jsonb_build_object(
                'id', v_signed_by.id,
    ...
    INSERT INTO public.diagnostic_reports (
        ...
        CASE WHEN p_signed_by_id IS NULL THEN NULL ELSE v_signed_by.id END,
        CASE WHEN p_signed_by_id IS NULL THEN NULL ELSE v_signed_by.full_name END,
        CASE WHEN p_signed_by_id IS NULL THEN NULL ELSE v_signed_by.id END,
        CASE WHEN p_signed_by_id IS NULL THEN NULL ELSE v_signed_by.full_name END,
        NOW(),
    ...
    SET status = 'SignedOff',
        ...
        signed_off_name = CASE WHEN p_signed_by_id IS NULL THEN NULL ELSE v_signed_by.full_name END,
        signed_off_at = NOW(),
        updated_at = NOW()
    ...
    INSERT INTO public.audit_logs (
        ...
        jsonb_build_object(
            ...
            'signed_by_personnel', CASE WHEN p_signed_by_id IS NULL THEN NULL ELSE v_signed_by.full_name END,
