...
const content109 = fs.readFileSync('supabase/migrations_legacy_archive/00109_fiacheck_analyzer_integration.sql', 'utf8');
...
let m;
while ((m = regex.exec(content109)) !== null) {
  matches.push({
    test_code: m[1],
    channel_code: m[2],
    channel_name: m[3],
...
console.log(`00109 regex matched ${matches.length} mappings:`);
